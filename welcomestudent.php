...
$b3=mysqli_query($con, "Select * from users where username='$siusername' and password='$sipassword'");
    ...
    if(isset($b4['username'])==$siusername  && ($b4['password'])==$sipassword)
    {
        ...
        $_SESSION['institute']=$b4['institute'];
        $_SESSION['gender']=$b4['gender'];
        $_SESSION['contact']=$b4['contact'];
        $_SESSION['image']=$b4['image'];
        $_SESSION['user_id']=$b4['user_id'];
    ...
    <body style="background:rgba(0,0,0,0.2)">
        <div class="container-fluid">
            <div class="row" style="background: grey;">
                <div class="col-md-8">
                        <h1 class="capitaize text-center glow" style="margin-top: 20px;margin-bottom: 25px">ATTENDENCE MANAGEMENT SYSTEM</h1>
                </div>
                <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12" style="margin-top: 50px">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div style="background:url('img/back.png');margin-top:50px;background-position-y:-100px;height:800px;width:80%;margin-left:20px">
                                <div>
                                    <p style="padding:10px;font-size:50px"><b>Welcome..</b></p>
                                </div>
                                <div>
                                    <p style="padding:10px;font-size:30px" class="text-capitalize">welcome to the student attendence management system. here we provide you with the best 
                                    management system to manage your attendence not just in numbers but we show you the stats of your attendence in terms of 
                                    bar graphs, histograms, and pie charts. we will show you the average attendence and wether you are clearing the average or not. we
                                    will also provide you the tips if you are falling out of the average to improve your stats.</p>
                                </div>
                        </div>
                    </div>
            </div>
